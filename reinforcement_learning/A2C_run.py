...
def run_prog(*seeds: int):
    ...
    gym_env.close()
    return total_reward_over_episodes


seed_count = rl_params['episode_count'] + 10
total_reward_over_episodes = run_prog(*seeds[:seed_count])
plt_reward_over_episodes(total_reward_over_episodes, 'ActorCritic (A2C)')
